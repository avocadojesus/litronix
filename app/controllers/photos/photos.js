...
module.exports = React.createClass({
  ...
  getInitialState: function() {
    return {
      ...
      images: [
        ...
        {src: "/img/photos/new-age-cover.png", credits: ""},
        {src: "/img/photos/Alexs-bar.jpg", credits: ""},
        {src: "/img/photos/hihat-2.jpg", credits: ""},
        {src: "/img/photos/house-show.jpg", credits: ""},
        {src: "/img/photos/la-record.jpg", credits: ""},
        {src: "/img/photos/litronix-hi-hat.jpg", credits: ""},
        {src: "/img/photos/offbeat.jpg", credits: ""},
        {src: "/img/photos/poster.jpg", credits: ""},
        {src: "/img/photos/prospector-live.jpg", credits: ""},
      ]
    };
  },
  ...
  __handleImageClick: function(e) {
    ...
    console.log(e, src, $(e.target).closest('.native-image'));
    this.setState({
      curr_image_src: src,
          ...
          <div className='room console'>
            <div className='image-container'>
              {this.state.images.map((image, i) => {
                return (
                  <NativeImage key={i} onTouchTap={this.__handleImageClick.bind(this)} src={image.src} />
                )
              })}
            </div>
          </div>
